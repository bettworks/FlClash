...
<Task version="1.3" xmlns="http://schemas.microsoft.com/windows/2004/02/mit/task">
  ...
  Future<void> optimizeNetwork(bool enable) async {
    if (enable) {
      ...
      // 禁用物理网卡 IPv6 (防泄漏)
      runas('powershell.exe', r'Get-NetAdapter | Where-Object { $_.InterfaceAlias -ne "LiClash" } | Disable-NetAdapterBinding -ComponentID ms_tcpip6');
    } else {
      // 恢复物理网卡 IPv6
      runas('powershell.exe', r'Get-NetAdapter | Where-Object { $_.InterfaceAlias -ne "LiClash" } | Enable-NetAdapterBinding -ComponentID ms_tcpip6');
    }
  }
}
